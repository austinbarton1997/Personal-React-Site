        ...
        <div class="container">
                ...
                <li class="media">
                    <div class="media-body">
                        <h5 class="mt-0 mb-1"><p class="featuredText">Featured Project</p>
                            <h4><a class="featuredTitle" href="https://github.com/austinbarton1997/Notes" without rel="noopener noreferrer" target="_blank">Notes App</a></h4></h5>
            ...
            <ul class="list-unstyled">
                <li class="media">
                    <div class="media-body">
                        <h5 class="mt-0 mb-1"><p class="featuredText">Featured Project</p>
                            <h4><a class="featuredTitle" href="https://github.com/austinbarton1997/Tinder-Movies" without rel="noopener noreferrer" target="_blank">Tinder Movies</a></h4></h5>
